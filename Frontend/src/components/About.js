...
export const About = ()=>{
    ...
    <><div>
            ...
            <p style={{ color: "#961e1b", marginTop: "70px", marginLeft: "70px", textAlign: "left" }}>About RaktKosh.com</p>
            <hr
                style={{
                    color: "black",
                    height: 5
        ...
        <Container style={{ backgroundColor: "lightgrey" }} className="info1">
        		<h1 style={{marginTop:"20px"}}>RaktKosh.com: A Blood Bank Management System</h1>
        
        </Container>
            
            <Container style={{ backgroundColor: "white" }} className="info1">
					<p className='para' style={{marginTop:"40px",textAlign:"justify"}} >
					RaktKosh.com enforces Drug & Cosmetic Act, National blood policy standards and guidelines ensuring proper collection & donation, effective management 
					and monitoring the quality and quantity of the donated blood. Considering the national roll out, RaktKosh.com has been developed with modular and scalable approach with
         ...
         <Container style={{ backgroundColor: "lightgray",textAlign:"justify" }} className="info1">
			...
			<p  style={{fontSize:"20px"}}>
				<b>RaktKosh.com has six major components for management of the
